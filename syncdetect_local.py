...
from PyQt5.QtWidgets import QLineEdit, QTextBrowser,QFileDialog
...
class ImageViewer_window(QtWidgets.QWidget):                          
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon(os.path.join(os.path.dirname(os.path.abspath(__file__)),"icon.svg")))
...
class MainWindow(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        Form, Base = uic.loadUiType(os.path.join(os.path.dirname(os.path.abspath(__file__)),"interface.ui"))
        self.ui = Form()
        self.ui.setupUi(self)
    ...
    def set_window(self, index, equation_image_name, dark_mode_image, input_fields, calc_func, ImageViewer_func):
        ...
        getattr(self.ui, f'eq_{index}').setPixmap(QPixmap(os.path.join(os.path.dirname(os.path.abspath(__file__)),equation_image)))
    ...
    def neural(self,index):
        self.list_of_images = os.listdir(path_dir)
        model = keras.models.load_model(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'sync_model.keras'))
